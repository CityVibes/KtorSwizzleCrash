...
*/
- (void)getDataWithCompletionHandler:(void (^)(SharedBreedResult * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getData(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiImpl")))
@interface SharedApiImpl : SharedBase <SharedApi>
...
- (instancetype)initWithMessage:(SharedMutableDictionary<NSString *, NSArray<NSString *> *> *)message status:(NSString *)status __attribute__((swift_name("init(message:status:)"))) __attribute__((objc_designated_initializer));
- (SharedMutableDictionary<NSString *, NSArray<NSString *> *> *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedBreedResult *)doCopyMessage:(SharedMutableDictionary<NSString *, NSArray<NSString *> *> *)message status:(NSString *)status __attribute__((swift_name("doCopy(message:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedMutableDictionary<NSString *, NSArray<NSString *> *> *message __attribute__((swift_name("message")));
